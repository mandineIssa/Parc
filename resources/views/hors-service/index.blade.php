    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-8">
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="w-full md:w-48">
                <select id="raisonFilter" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#A61B29] focus:border-[#A61B29] outline-none transition bg-white">
        ...
        <div class="mt-4 pt-4 border-t border-gray-100">
            <div class="flex flex-wrap gap-2">
                ...
                <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="all">
                    Tous
                </button>
                <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="en_attente">
                    En attente
                </button>
                <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-full bg-[#FDF2F3] text-[#7A0C1A] hover:bg-[#F8DADC] transition" data-filter="traite">
                    Traités
                </button>
                <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-full bg-[#FCEBEC] text-[#9F1F2C] hover:bg-[#F8DADC] transition" data-filter="panne">
                    Pannes
                </button>
                <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-full bg-[#FDF2F3] text-[#7A0C1A] hover:bg-[#F8DADC] transition" data-filter="obsolescence">
                    Obsolètes
                </button>
                <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="valeur_estimee">
                    Avec valeur
                </button>
            </div>
        </div>
