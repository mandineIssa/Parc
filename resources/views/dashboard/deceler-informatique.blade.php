    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-8">
        ...
        <div class="mt-4 pt-4 border-t border-gray-100">
            <div class="flex flex-wrap gap-2">
                ...
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="reparable">
                    ⚠️ Réparable
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-[#FCEBEC] text-[#9F1F2C] hover:bg-[#F8DADC] transition" data-filter="irreparable">
                    ❌ Irréparable
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="parc">
                    📋 Parc
                </button>
