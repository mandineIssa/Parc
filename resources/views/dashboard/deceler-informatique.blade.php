...
<div class="container-fluid mx-auto px-4 py-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm text-gray-500">Total équipements DECELER</p>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold">{{ number_format($stats['valeur_totale'], 2, ',', ' ') }} €</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Dashboard Stock DECELER - Informatique</h1>
            <p class="text-gray-600 mt-1">Gestion des équipements informatiques retournés (DECELER)</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        <div class="px-6 py-4 border-b">
            <h2 class="text-lg font-semibold text-gray-700">Filtres DECELER</h2>
        </div>
        <form action="{{ route('dashboard.deceler-informatique.filter') }}" method="GET" class="px-6 py-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('dashboard.deceler-informatique') }}" 
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nom de l'Équipement</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($stock->deceler && $stock->deceler->etat_retour)
                                <div class="font-medium text-gray-900">{{ $stock->deceler->etat_retour }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($stock->equipment)
                                <div class="font-medium text-gray-900">{{ $stock->equipment->nom ?? $stock->equipment->type }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($stock->equipment)
                                <div class="font-medium text-gray-900">{{ $stock->equipment->modele ?? '-' }}</div>
                            @else
                                <span class="text-gray-400">-</span>
                            @endif
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($stock->deceler && $stock->deceler->origine)
                                <div class="font-medium text-gray-900">{{ ucfirst($stock->deceler->origine) }}</div>
                            @else
                                <span class="text-gray-400">-</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-4 text-center text-gray-500">
                            Aucun équipement informatique DECELER trouvé
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="mt-6 bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b">
            <h2 class="text-lg font-semibold text-gray-700">Derniers retours DECELER</h2>
        </div>
        <div class="px-6 py-4">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="border rounded p-4 hover:bg-gray-50">
                    ...
                    @if($recent->equipment)
                        <div class="text-sm text-gray-600">{{ $recent->equipment->marque }} {{ $recent->equipment->modele }}</div>
                    @endif
...
@push('styles')
<style>
    /* Styles personnalisés pour le dashboard DECELER */
