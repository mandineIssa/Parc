{{-- resources/views/dashboard/deceler-electronique.blade.php --}}
@extends('layouts.app')
...
<div class="container-fluid mx-auto px-4 py-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm text-gray-500">Total équipements DECELER Électronique</p>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold">{{ number_format($stats['valeur_totale'] * 0.25, 2, ',', ' ') }} €</p>
                    <p class="text-xs text-gray-400">(25% de la valeur totale)</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Dashboard Stock DECELER - Électronique</h1>
            <p class="text-gray-600 mt-1">Gestion des équipements électroniques retournés (DECELER)</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        <div class="px-6 py-4 border-b">
            <h2 class="text-lg font-semibold text-gray-700">Filtres DECELER Électronique</h2>
        </div>
        <form action="{{ route('dashboard.deceler-electronique.filter') }}" method="GET" class="px-6 py-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('dashboard.deceler-electronique') }}" 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            @if($stock->deceler && $stock->deceler->diagnostic)
                                <div class="text-sm text-gray-700 truncate max-w-xs">{{ $stock->deceler->diagnostic }}</div>
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-4 text-center text-gray-500">
                            Aucun équipement électronique DECELER trouvé
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <!-- Récentes entrées DECELER Électronique -->
    <div class="mt-6 bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b">
            <h2 class="text-lg font-semibold text-gray-700">Derniers retours DECELER Électronique</h2>
        </div>
        <div class="px-6 py-4">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="border rounded p-4 hover:bg-gray-50">
                    ...
                    @if($recent->deceler)
                        <div class="text-xs text-gray-500 mt-2">
                            <span class="font-medium">{{ $recent->deceler->origine ?? '' }}</span><br>
                ...
                <div class="col-span-5 text-center text-gray-500 py-4">
                    Aucun retour électronique récent
                </div>
                @endforelse
            </div>
        </div>
...
@push('styles')
<style>
    /* Styles personnalisés pour le dashboard DECELER Électronique */
