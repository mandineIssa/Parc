...
<div class="container-fluid mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Gestion des équipements réseau en stock Celer</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        ...
        <form action="{{ route('dashboard.celer-reseau') }}" method="GET" class="px-6 py-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div>
                    ...
                    <input type="text" name="marque" 
                           ...
                           placeholder="Ex: Cisco, HP, Ubiquiti"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="modele" 
                           ...
                           placeholder="Ex: Catalyst, Switch, Router"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div >
                    ...
                    <div class="relative">
                        <input type="text" name="search" 
                               ...
                               placeholder="Rechercher par N° série, marque, modèle, adresse MAC..."
            ...
            <div class="flex items-end mt-6 gap-3">
                ...
                @if(request()->anyFilled(['numero_serie', 'marque', 'modele', 'etat', 'fournisseur_nom', 'search']))
                <a href="{{ route('dashboard.celer-reseau') }}" 
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 mb-2">Aucun équipement réseau Celer trouvé</h3>
                                <p class="text-gray-500 mb-4">
                                    @if(request()->anyFilled(['numero_serie', 'marque', 'modele', 'etat', 'fournisseur_nom', 'search']))
                                        Aucun résultat ne correspond à vos critères de recherche
                                    @else
                                        Commencez par ajouter un équipement réseau
                                    @endif
                                </p>
                                <a href="{{ route('equipment.create') }}" 
