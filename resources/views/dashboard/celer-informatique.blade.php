    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-8">
        ...
        <div class="mt-4 pt-4 border-t border-gray-100">
            <div class="flex flex-wrap gap-2">
                ...
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-[#FDF2F3] text-[#7A0C1A] hover:bg-[#F8DADC] transition" data-filter="all">
                    Tous
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-[#FDF2F3] text-[#7A0C1A] hover:bg-[#F8DADC] transition" data-filter="neuf">
                    Neuf
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-[#FDF2F3] text-[#7A0C1A] hover:bg-[#F8DADC] transition" data-filter="bon">
                    Bon
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="moyen">
                    Moyen
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-[#FCEBEC] text-[#9F1F2C] hover:bg-[#F8DADC] transition" data-filter="mauvais">
                    Mauvais
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition" data-filter="cher">
                    Plus chers (> 500k)
                </button>
                <button class="filter-badge px-3 py-1.5 text-sm font-medium rounded-full bg-[#FDF2F3] text-[#7A0C1A] hover:bg-[#F8DADC] transition" data-filter="recent">
                    Récent (mois)
                </button>
            </div>
        </div>
