...
<div class="container-fluid mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Gestion des équipements informatiques en stock</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        ...
        <form action="{{ route('dashboard.celer-informatique') }}" method="GET" class="px-6 py-4">
            ...
            <div class="flex items-end mt-6 gap-3">
                ...
                <a href="{{ route('dashboard.celer-informatique') }}" 
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-lg font-medium">Aucun équipement informatique en stock trouvé</p>
                                <p class="text-sm text-gray-500 mt-1">Commencez par ajouter un équipement informatique</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
