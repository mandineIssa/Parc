...
<div class="container mx-auto px-4 py-8 max-w-4xl">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Détails Stock Celer</h1>
        <a href="{{ route('dashboard.celer-informatique') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
            Retour au dashboard
        </a>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="px-6 py-4 border-b bg-blue-50">
            <div class="flex justify-between items-center">
                <h2 class="text-lg font-semibold text-gray-700">Informations Stock</h2>
        ...
        <div class="px-6 py-4">
                ...
                <div class="space-y-4">
                    ...
                    @if($stock->celer)
                        <div>
                            ...
                            <p class="mt-1 text-gray-900">{{ $stock->celer->date_acquisition ? $stock->celer->date_acquisition->format('d/m/Y') : 'Non renseignée' }}</p>
                        </div>
                    @endif
                    ...
                    <div>
                        ...
                        @if($stock->date_sortie)
                            <span class="px-2 py-1 bg-red-100 text-red-800 rounded text-sm">Sorti</span>
                        @else
                            <span class="px-2 py-1 bg-green-100 text-green-800 rounded text-sm">En stock</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            @if($stock->equipment)
            <div class="mt-8 pt-8 border-t">
                <h3 class="text-lg font-semibold text-gray-700 mb-4">Informations Équipement</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
