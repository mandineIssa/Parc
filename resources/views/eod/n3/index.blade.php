...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-[#C8102E]">Supervision des traitements EOD</h1>
        ...
        <div class="flex flex-wrap gap-3 mt-4 md:mt-0">
            ...
            <a href="{{ route('eod.n3.statistiques') }}" class="bg-[#4a4a4a] hover:bg-[#333333] text-white font-semibold py-2 px-4 rounded-lg transition-colors inline-flex items-center">
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-[#C8102E] h-2 rounded-full" style="width: {{ $stats['total'] > 0 ? ($count / $stats['total'] * 100) : 0 }}%"></div>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 col-span-1">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-lg font-bold text-[#C8102E]">{{ $contrib->total }}</span>
                </div>
                @empty
        ...
        <div class="bg-white rounded-xl shadow-md p-6 col-span-1">
            ...
            <div class="h-48 flex items-end justify-between gap-1">
                ...
                <div class="flex flex-col items-center flex-1">
                    <div class="w-full bg-red-100 rounded-t" style="height: {{ ($jour->total / $max) * 100 }}%"></div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('eod.n3.show', $fiche) }}" class="text-[#C8102E] hover:text-[#7a0c22]">
