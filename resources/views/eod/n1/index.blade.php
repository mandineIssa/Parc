                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('eod.n1.edit', $fiche) }}" title="Voir" class="text-gray-600 hover:text-gray-900">
                                    ...
                                    <a href="{{ route('eod.n1.edit', $fiche) }}" title="Modifier" class="text-blue-600 hover:text-blue-800">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form action="{{ route('eod.n1.destroy', $fiche) }}" method="POST" class="inline"
